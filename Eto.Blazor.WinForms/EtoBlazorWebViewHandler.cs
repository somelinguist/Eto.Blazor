...
using aspw = Microsoft.AspNetCore.Components.WebView.WindowsForms;

namespace Eto.Blazor.WinForms
{
    public class EtoBlazorWebViewHandler : WindowsControl<aspw.BlazorWebView, eb.BlazorWebView, eb.BlazorWebView.ICallback>, eb.BlazorWebView.IHandler
    {
        ...
        private void OnRootComponentsCollectionChanged(object? sender, global::System.Collections.Specialized.NotifyCollectionChangedEventArgs eventArgs)
        {
            ...
            //{
                ...
                {
                    var component = new aspw.RootComponent(item.Selector, item.ComponentType, item.Parameters);
